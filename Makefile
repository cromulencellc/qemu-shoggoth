...
GENERATED_FILES += qapi/qapi-commands-oshandler.c qapi/qapi-commands-oshandler.h
GENERATED_FILES += qapi/qapi-visit-oshandler.c qapi/qapi-visit-oshandler.h
...
GENERATED_FILES += $(PLUGIN_GENERATED_FILES)
...
all: $(DOCS) $(TOOLS) $(HELPERS-y) recurse-all modules all-plugins

.PHONY: all-plugins

ifdef CONFIG_ENABLE_PLUGINS
include $(SRC_PATH)/plugins/Makefile
all-plugins: plugins modules
clean-plugins: plugins_clean
else
all-plugins: ;
clean-plugins: ;
endif
...
qapi/qapi-visit-oshandler.c qapi/qapi-visit-oshandler.h \
...
qapi/qapi-commands-oshandler.c qapi/qapi-commands-oshandler.h \
