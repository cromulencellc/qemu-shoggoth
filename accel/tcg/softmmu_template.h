...
# define instrumentation_st_name glue(glue(instrumentation_st, SUFFIX), MMUSUFFIX)
# define instrumentation_ld_name glue(glue(instrumentation_ld, SUFFIX), MMUSUFFIX)
