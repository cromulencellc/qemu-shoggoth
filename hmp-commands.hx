...
ETEXI

    {
        ...
        .args_type  = "file:s?",
        .params     = "file",
        .help       = "Saves the system state to a rsave snapshot",
        .cmd        = hmp_rapid_save,
    },

STEXI
@item rsavevm [@var{file}]
@findex rsavevm
Create a snapshot of the whole virtual machine. The snapshot will be 
saved to a file which can be used to initiate a Rapid Analysis session.
If @var{file} is provided, it is used as the file name.
ETEXI
...
ETEXI

    {
        ...
        .args_type  = "file:s",
        .params     = "file",
        .help       = "Loads the system state from a rsave snapshot",
        .cmd        = hmp_rapid_load,
    },

STEXI
@item rloadvm [@var{file}]
@findex rloadvm
Loads the specified system state from a rsave snapshot 
located in @var{file} and starts a Rapid Analysis session.
ETEXI
...
ETEXI

    {
        ...
        .args_type  = "type:s?",
        .params     = "type",
        .help = "Enable os handlers and activate the specified type.",
        .cmd  = hmp_os,
    },
...
@item os
@findex os
Toggle OS handler enabled/disabled  DEFAULT: Disabled
ETEXI
...
@item exec
@findex exec
Replace a process with a new loadable executable
ETEXI
    {
        .name      = "exec",
        .args_type = "cmd:S",
        .params    = "",
        .help      = "directly execute a plugin command",
        .cmd       = hmp_exec,
    },
