 ...
 * @name: the QOM typnm of @class_type.
 *
...
#define OBJECT_CLASS_CHECK(class_type, klass, name) \
    ((class_type *)object_class_dynamic_cast_assert(OBJECT_CLASS(klass), (name), \
                                               __FILE__, __LINE__, __func__))
 ...
 * @name: The QOM typnm of @obj.
 *
 * This function will return a specific class for a given object.  Its generally
 * used by each type to provide a type safe macro to get a specific class type
 * from an object.
 */
#define OBJECT_GET_CLASS(klass, obj, name) \
    OBJECT_CLASS_CHECK(klass, object_get_class(OBJECT(obj)), name)
...
/**
 * object_new:
 * @typnm: The name of the type of the object to instantiate.
 *
 ...
 */
Object *object_new(const char *typnm);
 ...
 */
Object *object_new_with_props(const char *typnm,
                              Object *parent,
                              const char *id,
                              Error **errp,
                              ...) QEMU_SENTINEL;
 ...
 */
Object *object_new_with_propv(const char *typnm,
                              Object *parent,
                              const char *id,
                              Error **errp,
                              va_list vargs);
 ...
 */
void object_initialize(void *obj, size_t size, const char *typnm);
 ...
 * @typnm: The @typnm to cast to.
 *
 * This function will determine if @obj is-a @typnm.  @obj can refer to an
 * object or an interface associated with an object.
 *
 * Returns: This function returns @obj on success or #NULL on failure.
 */
Object *object_dynamic_cast(Object *obj, const char *typnm);
 ...
 */
Object *object_dynamic_cast_assert(Object *obj, const char *typnm,
 ...
 * @obj: A derivative of #Object.
 *
 * Returns: The QOM typnm of @obj.
 */
const char *object_get_typnm(const Object *obj);
 ...
 * @typnm: The QOM typnm of the class to cast to.
 *
 ...
 * @typnm: The QOM typnm of the class to cast to.
 *
 * Returns: If @typnm is a class, this function returns @klass if
 * @typnm is a subtype of @klass, else returns #NULL.
 *
 * If @typnm is an interface, this function returns the interface
 ...
 * @klass: The class to obtain the QOM typnm for.
 *
 * Returns: The QOM typnm for @klass.
 */
 ...
 * @typnm: The QOM typnm to obtain the class for.
 *
 * Returns: The class for @typnm or %NULL if not found.
 */
ObjectClass *object_class_by_name(const char *typnm);
 ...
 * @obj: the object
 * @name: the name of the property
 * @typnm: the name of the enum data type
 * @errp: returns an error if this function fails
 *
 ...
 * a dynamic cast to @typnm.  This is important if either the link,
 * or the typnm itself are of interface types.
 *
 * Returns: The matched object or NULL on path lookup failure.
 */
Object *object_resolve_path_type(const char *path, const char *typnm,
                                 bool *ambiguous);
 ...
 * @typnm: Name of the Type whose instance_size is required
 *
 * Returns the instance_size of the given @typnm.
 */
size_t object_type_get_instance_size(const char *typnm);
#endif
